...
import com.example.aw.berita.adapter.TimelineListAdapter;
...
public class Timeline extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        timelineItems.add(new TimelineItem("fakhri", "12 januari", "facebook.com", "hahahah"));
        timelineItems.add(new TimelineItem("fakhri", "12 januari", "facebook.com", "hahahah"));
        timelineItems.add(new TimelineItem("fakhri", "12 januari", "facebook.com", "hahahah"));
        timelineItems.add(new TimelineItem("fakhri", "12 januari", "facebook.com", "hahahah"));
        timelineItems.add(new TimelineItem("fakhri", "12 januari", "facebook.com", "hahahah"));
        ...
        listAdapter = new TimelineListAdapter(v.getContext(), timelineItems);
